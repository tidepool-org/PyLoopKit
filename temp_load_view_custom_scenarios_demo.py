...
Acknowlegements:
    Credit for the hard work that went into porting the Loop Algorithm from
    swift to python goes to Anna Quinlan (Summer Intern Project 2019). Her work
    can be found on [github](https://github.com/tidepool-org/PyLoopKit).

Running on your local machine:
    If you are interested in loading in a scenario from an issue report and
    running PyLoopKit on your local machine, please follow the PyLoopKit
    [instructions]
    (https://github.com/tidepool-org/PyLoopKit/blob/develop/README.md)
    and take a look at [example.py]
    (https://github.com/tidepool-org/PyLoopKit/blob/develop/example.py)


Today's Demo (Load & View Custom Scenario) from Chrome
    The work presented today (as of 2019-10-10) is inspired by work that currently
    lives in a [dev branch]
    (https://github.com/tidepool-org/PyLoopKit/tree/etn/load-custom-scenarios).
"""
...
cutom_scenario_files = [
    ...
    "custom-scenario-template.csv",
    "custom-scenario-table-template-simple-for-risk.csv"
]
