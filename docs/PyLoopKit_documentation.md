...
*   As you read through this doc **<code>red() </code></strong>is used for functions, <strong><code>blue </code></strong>refers to modules, and <strong><code>orange </code></strong>is used for variable names.
...
1. Momentum effects: **<code>get_recent_momentum_effects()</code></strong> in <code>glucose_store.py</code>
...
*   Dictionary of input data
    *   Key: “input_data”
    *   Can be used to re-run the algorithm in the future if desired<p style="color: red; font-weight: bold">>>>>>  gd2md-html alert:  ERRORs: 0; WARNINGs: 0; ALERTS: 1.</p>
...
<p id="gdcalert1" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/PyLoopKit-Documentation0.png). Store image on your image server and adjust path/filename if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/PyLoopKit-Documentation0.png "image_tooltip")
