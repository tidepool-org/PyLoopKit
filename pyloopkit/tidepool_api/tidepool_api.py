...
# -*- coding: utf-8 -*-
"""
This code is from the following repository:
https://github.com/tidepool-org/data-science-tidepool-api-python
    ...
    def _check_login(func):
        ...
        def is_logged_in(self, *args, **kwargs):
            if self._login_headers is None or self._login_user_id is None:
                raise Exception("Not logged in. You probably typed in wrong Tidepool email or password.")
