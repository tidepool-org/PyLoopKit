...
class TestCarbKitFunctions(unittest.TestCase):
    ...
    def test_dynamic_glucose_effect_absorption_partially_observed_multiple(self):
        input_ice = self.load_ice_input_fixture("ice_35_min_input")
        ...
        carb_entry_starts = carb_starts[0:2]
        carb_entry_quantities = carb_values[0:2]
        carb_entry_absorptions = carb_absorptions[0:2]
        ...
        self.assertEqual(len(absorptions), 2)
        self.assertAlmostEqual(absorptions[0][0], 15.973, 3)
        self.assertAlmostEqual(absorptions[1][0], 2.02703, 3)
    ...
    def test_dynamic_glucose_effect_absorption_partially_observed_many(self):
        input_ice = self.load_ice_input_fixture("ice_1_hour_input")
        ...
        carb_entry_starts = carb_starts
        carb_entry_quantities = carb_values
        carb_entry_absorptions = [120, 240, 60]#carb_absorptions
        ...
        self.assertEqual(len(absorptions), 3)
